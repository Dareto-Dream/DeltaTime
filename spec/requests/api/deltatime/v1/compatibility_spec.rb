...
RSpec.describe 'Api::Deltatime::V1::Compatibility', type: :request do
  path '/api/deltatime/v1/users/{id}/heartbeats' do
  ...
  path '/api/deltatime/v1/users/{id}/heartbeats.bulk' do
    post('Push heartbeats in bulk (WakaTime compatible)') do
      ...
      parameter name: :heartbeats, in: :body, schema: {
        type: :array,
        description: 'Array of heartbeats (max 100). May be sent as a top-level JSON array, a text/plain JSON array, or wrapped as { deltatime: { heartbeats: [...] } }.',
        items: {
          type: :object,
          properties: {
  ...
  path '/api/deltatime/v1/users/{id}' do
  ...
  path '/api/deltatime/v1/users/{id}/summaries' do
  ...
  path '/api/deltatime/v1/users/{id}/statusbar/today' do
  ...
  path '/api/deltatime/v1/users/current/stats/last_7_days' do

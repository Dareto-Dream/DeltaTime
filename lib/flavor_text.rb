class FlavorText
  ...
  def self.motto
    [
      ...
      "from the #{%w[makers inventor].sample} of #{%w[clocks time deltatime].sample}",
      ...
      "It takes a long time to build something good: <a href='https://github.com/Dareto-Dream/DeltaTime#readme' target='_blank'><img src='https://hackatime-badge.hackclub.com/U0C7B14Q3/harbor'></a>".html_safe,
  ...
  def self.rare_motto
    [
      ...
      "<a href='https://github.com/Dareto-Dream/DeltaTime' target='_blank'>open source!</a>".html_safe,
